    ...
    "Экономика": {
        ...
        "Предпринимательство": {
            ...
            "key_points": [
                ...
                "Риск — возможность потерь в бизнеса"
            ],
            "examples": [
    ...
    "Право": {
        ...
        "Правоотношения и юридическая ответственность": {
            ...
            "examples": [
                ...
                "Юридическая ответственность: штраф за нарушение ПДД, лишение свобода за преступление"
            ],
            "questions": [
...
def get_answer_keyboard(task_id, question_type, is_exam=False):
    ...
    if not is_exam:
        ...
        builder.button(text="🎲 СЛЕДУЮЩЕЕ", callback_data="random_task")
    else:
